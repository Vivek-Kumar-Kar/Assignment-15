...
namespace Day_12_Assignment_15
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"ArraySize {arr.Length} Time Taken in Merge Sort {stopwatch1.Elapsed.TotalMilliseconds} milliseconds");
